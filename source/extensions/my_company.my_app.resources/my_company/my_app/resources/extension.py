...
# Functions and vars are available to other extensions as usual in python: `my_company.my_app.resources.some_public_function(x)`
...
class MyExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id):
        print("[my_company.my_app.resources] Extension startup")

    def on_shutdown(self):
        print("[my_company.my_app.resources] Extension shutdown")
